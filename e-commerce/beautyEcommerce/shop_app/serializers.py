...
class ClientSerializer(serializers.ModelSerializer):
    id = serializers.UUIDField(source='utilisateur.id')
    ...
    tel = serializers.CharField(source='utilisateur.tel')

    class Meta:
        model = Client
        fields = ['id', 'nom', 'prenom', 'email', 'tel']
...
class NotificationSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Notification
        fields = ['id', 'utilisateur', 'message', 'dateEnvoi']
...
class UserSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = ['id','nom', 'prenom', 'email','tel','password'] 

...
urlpatterns = [
    ...
    path('api/client/commandes/', ClientCommandeListView.as_view(), name='client-commandes-list'),
    ...
    path('api/client/commandes/<uuid:id>/status/', changer_statut.as_view(), name='client-update-commande-status'),
